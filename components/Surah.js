...
const Surah = () => {
  return (
    <div className='flex flex-col mt-7 justify-center items-center'>
      ...
      <div className='surahList text-green-900 w-[100vw] h-[60vh] mt-7 bg-linear-to-r from-green-300/10 to-green-300/30'>
        <div
          id='parahContainer'
    ...
    parahNames.forEach((name, index) => {
      const html = \`
        <div class='surah-div flex gap-4 '>
          <div class='eachSurah bg-linear-to-r from-green-500/10 to-green-500/20 h-13 w-40 flex border-1 border-solid border-green-900 rounded-lg shadow-lg h-6 w-50 gap-1 px-2 items-center hover:bg-green-600/70 hover:text-white'>
