...
//       {/* Quran Quote Section */}
//       <div className='flex gap-4 justify-center items-center w-full px-2 sm:px-2 md:px-3 py-20 my-5 bg-gradient-to-r from-green-400/40 to-white text-green-900 text-center rounded-md'>
