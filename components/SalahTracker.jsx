      ...
      <div className='flex flex-col-reverse md:flex-row justify-between items-center gap-6'>
        ...
        <div className='flex flex-col gap-4 md:w-3/4'>
          ...
          <p className='text-sm sm:text-base text-green-800 text-shadow-green-600 leading-relaxed text-justify'>
            In the Fid-Duniya Wal-Akhirah platform, you can set a prayer
            reminder to meet daily prayer goals. We have been working on this
            exciting feature to keep you aligned with the daily five times
            prayers. In order to accomplish the most important farz of the day,
            Salah, we have been launching this feature very soon!
          </p>
        </div>
